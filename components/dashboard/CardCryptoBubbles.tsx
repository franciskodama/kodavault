...
export default function CardCryptoBubbles({
  allCryptos,
  userAssets,
}: CardCryptoBubblesProps) {
                  ...
                  return (
                    <div
                      ...
                      className={`rounded-full flex flex-col items-center justify-center text-white select-none
                        ${
                          isPositive
                            ? 'bg-gradient-to-tr from-emerald-800 to-teal-600/95 border border-emerald-400/40 shadow-[0_4px_12px_rgba(16,185,129,0.2)]'
                            : 'bg-gradient-to-tr from-rose-800/90 to-red-600/95 border border-rose-400/40 shadow-[0_4px_12px_rgba(244,63,94,0.2)]'
                        }
                        ${
                          node.isPortfolio
