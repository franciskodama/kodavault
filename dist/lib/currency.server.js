...
const getCurrency = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const csv = yield fetch(`https://docs.google.com/spreadsheets/d/e/2PACX-1vRXhHkYpkVB8nx8Ws7Q4h8g6q7MJg-rotoQemAfPdRWXhWHJWjivg7fcDw4m-9YxnQvPyxEkwpTKopW/pub?gid=0&single=true&output=csv`, {
            method: 'GET',
            headers: {
        ...
        const result = data.reduce((acc, { coin, price }) => {
