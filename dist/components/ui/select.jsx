...
const SelectTrigger = React.forwardRef((_a, ref) => {
    ...
    return (<SelectPrimitive.Trigger ref={ref} className={(0, utils_1.cn)('flex h-10 w-full items-center justify-between rounded-[2px] border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1', className)} {...props}>
    {children}
...
const SelectItem = React.forwardRef((_a, ref) => {
    var { className, children } = _a, props = __rest(_a, ["className", "children"]);
    return (<SelectPrimitive.Item ref={ref} className={(0, utils_1.cn)('relative flex w-full cursor-default select-none items-center rounded-[2px] py-1.5 pl-8 pr-2 text-sm outline-none focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50', className)} {...props}>
