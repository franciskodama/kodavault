...
const Card = React.forwardRef((_a, ref) => {
    ...
    return (<div ref={ref} className={(0, utils_1.cn)('rounded-sm border bg-card text-xs text-slate-600 font-light text-card-foreground shadow-sm', className)} {...props}/>);
});
exports.Card = Card;
Card.displayName = 'Card';
const CardHeader = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (<div ref={ref} className={(0, utils_1.cn)('flex flex-col space-y-1.5 px-4 py-6', className)} {...props}/>);
});
exports.CardHeader = CardHeader;
CardHeader.displayName = 'CardHeader';
const CardTitle = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (<h3 ref={ref} className={(0, utils_1.cn)('text-xl font-semibold leading-none tracking-tight', className)} {...props}/>);
});
...
const CardContent = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (<div ref={ref} className={(0, utils_1.cn)('p-4 pt-0', className)} {...props}/>);
});
