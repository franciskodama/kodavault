...
const TableRow = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (<tr ref={ref} className={(0, utils_1.cn)('border-b transition-colors hover:bg-accent/50 data-[state=selected]:bg-muted', className)} {...props}/>);
});
exports.TableRow = TableRow;
TableRow.displayName = 'TableRow';
const TableHead = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (<th ref={ref} className={(0, utils_1.cn)('h-12 px-4 text-right align-middle font-medium text-muted-foreground [&:has([role=checkbox])]:pr-0', className)} {...props}/>);
});
exports.TableHead = TableHead;
TableHead.displayName = 'TableHead';
const TableCell = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (<td ref={ref} className={(0, utils_1.cn)('py-[6px] px-4 align-middle [&:has([role=checkbox])]:pr-0', className)} {...props}/>);
});
