...
export type UserSettingsWhereInput = {
  ...
  uid?: Prisma.StringFilter<"UserSettings"> | string
  periodStart?: Prisma.DateTimeNullableFilter<"UserSettings"> | Date | string | null
  period?: Prisma.StringNullableFilter<"UserSettings"> | string | null
  createdAt?: Prisma.DateTimeFilter<"UserSettings"> | Date | string
  updatedAt?: Prisma.DateTimeFilter<"UserSettings"> | Date | string
  view?: Prisma.BoolFilter<"UserSettings"> | boolean
...
export type UserSettingsScalarWhereWithAggregatesInput = {
  ...
  uid?: Prisma.StringWithAggregatesFilter<"UserSettings"> | string
  periodStart?: Prisma.DateTimeNullableWithAggregatesFilter<"UserSettings"> | Date | string | null
  period?: Prisma.StringNullableWithAggregatesFilter<"UserSettings"> | string | null
  ...
  view?: Prisma.BoolWithAggregatesFilter<"UserSettings"> | boolean
...
export type UserSettingsOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"uid" | "periodStart" | "period" | "createdAt" | "updatedAt" | "view" | "id", ExtArgs["result"]["userSettings"]>
...
export interface UserSettingsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `uid`
   * const userSettingsWithUidOnly = await prisma.userSettings.findMany({ select: { uid: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many UserSettings and only return the `uid`
   * const userSettingsWithUidOnly = await prisma.userSettings.createManyAndReturn({
   *   select: { uid: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more UserSettings and only return the `uid`
   * const userSettingsWithUidOnly = await prisma.userSettings.updateManyAndReturn({
   *   select: { uid: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface UserSettingsFieldRefs {
  readonly uid: Prisma.FieldRef<"UserSettings", 'String'>
  readonly periodStart: Prisma.FieldRef<"UserSettings", 'DateTime'>
  readonly period: Prisma.FieldRef<"UserSettings", 'String'>
  readonly createdAt: Prisma.FieldRef<"UserSettings", 'DateTime'>
  readonly updatedAt: Prisma.FieldRef<"UserSettings", 'DateTime'>
  readonly view: Prisma.FieldRef<"UserSettings", 'Boolean'>
